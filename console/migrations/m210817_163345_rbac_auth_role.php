...
class m210817_163345_rbac_auth_role extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%rbac_auth_role}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='系统_角色表'");
        
        /* 索引设置 */
        
        
        /* 表数据 */
        $this->insert('{{%rbac_auth_role}}',['id'=>'1','merchant_id'=>'0','title'=>'管理员','app_id'=>'backend','pid'=>'0','level'=>'1','sort'=>'0','tree'=>'tr_0 ','is_default'=>'0','status'=>'1','created_at'=>'1629090576','updated_at'=>'1629091932']);
