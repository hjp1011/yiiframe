...
class m210817_163345_rbac_auth_item extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%rbac_auth_item}}',['id'=>'10','name'=>'commonConfig','title'=>'配置管理','app_id'=>'backend','addons_name'=>'','pid'=>'9','level'=>'3','is_addon'=>'0','sort'=>'1','tree'=>'tr_0 tr_38 tr_41 ','status'=>'1','created_at'=>'1582376901','updated_at'=>'1616337636']);
        ...
        $this->insert('{{%rbac_auth_item}}',['id'=>'13','name'=>'commonMenu','title'=>'菜单管理','app_id'=>'backend','addons_name'=>'','pid'=>'9','level'=>'3','is_addon'=>'0','sort'=>'2','tree'=>'tr_0 tr_38 tr_41 ','status'=>'1','created_at'=>'1582376901','updated_at'=>'1616337808']);
        ...
        $this->insert('{{%rbac_auth_item}}',['id'=>'33','name'=>'/plugs/*','title'=>'插件市场','app_id'=>'backend','addons_name'=>'','pid'=>'5','level'=>'2','is_addon'=>'0','sort'=>'4','tree'=>'tr_0 tr_38 ','status'=>'1','created_at'=>'1582376900','updated_at'=>'1616341734']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'34','name'=>'/gii/*','title'=>'代码生成','app_id'=>'backend','addons_name'=>'','pid'=>'5','level'=>'2','is_addon'=>'0','sort'=>'5','tree'=>'tr_0 tr_38 ','status'=>'1','created_at'=>'1582376900','updated_at'=>'1616341734']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'35','name'=>'/common/system/info','title'=>'系统信息','app_id'=>'backend','addons_name'=>'','pid'=>'5','level'=>'2','is_addon'=>'0','sort'=>'4','tree'=>'tr_0 tr_38 ','status'=>'1','created_at'=>'1582376904','updated_at'=>'1616341732']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'36','name'=>'cate:2','title'=>'应用中心','app_id'=>'backend','addons_name'=>'','pid'=>'0','level'=>'1','is_addon'=>'0','sort'=>'5','tree'=>'tr_0 ','status'=>'1','created_at'=>'1582376906','updated_at'=>'1616341737']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'37','name'=>'base','title'=>'系统基础','app_id'=>'merchant','addons_name'=>'','pid'=>'0','level'=>'1','is_addon'=>'0','sort'=>'0','tree'=>'tr_0 ','status'=>'1','created_at'=>'1582376927','updated_at'=>'1582376927']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'38','name'=>'/merchants/base/member/personal','title'=>'个人信息','app_id'=>'merchant','addons_name'=>'','pid'=>'37','level'=>'2','is_addon'=>'0','sort'=>'1','tree'=>'tr_0 tr_126 ','status'=>'1','created_at'=>'1582376927','updated_at'=>'1613934939']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'39','name'=>'/merchants/base/member/up-password','title'=>'修改密码','app_id'=>'merchant','addons_name'=>'','pid'=>'37','level'=>'2','is_addon'=>'0','sort'=>'2','tree'=>'tr_0 tr_126 ','status'=>'1','created_at'=>'1582376927','updated_at'=>'1613934940']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'40','name'=>'/main/clear-cache','title'=>'清理缓存','app_id'=>'merchant','addons_name'=>'','pid'=>'37','level'=>'2','is_addon'=>'0','sort'=>'3','tree'=>'tr_0 tr_126 ','status'=>'1','created_at'=>'1582376897','updated_at'=>'1582376897']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'41','name'=>'cate:3','title'=>'应用中心','app_id'=>'merchant','addons_name'=>'','pid'=>'0','level'=>'1','is_addon'=>'0','sort'=>'3','tree'=>'tr_0 ','status'=>'1','created_at'=>'1582376930','updated_at'=>'1582376930']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'42','name'=>'sysReport','title'=>'系统看板','app_id'=>'backend','addons_name'=>'','pid'=>'1','level'=>'2','is_addon'=>'0','sort'=>'3','tree'=>'tr_0 tr_1  ','status'=>'1','created_at'=>'1582376930','updated_at'=>'1582376930']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'43','name'=>'/main/login-count','title'=>'登录统计','app_id'=>'backend','addons_name'=>'','pid'=>'42','level'=>'3','is_addon'=>'0','sort'=>'1','tree'=>'tr_0 tr_1 tr_42  ','status'=>'1','created_at'=>'1582376930','updated_at'=>'1582376930']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'44','name'=>'/main/member-count','title'=>'用户统计','app_id'=>'backend','addons_name'=>'','pid'=>'42','level'=>'3','is_addon'=>'0','sort'=>'2','tree'=>'tr_0 tr_1 tr_42  ','status'=>'1','created_at'=>'1582376930','updated_at'=>'1582376930']);
        $this->insert('{{%rbac_auth_item}}',['id'=>'45','name'=>'/main/log-count','title'=>'日志统计','app_id'=>'backend','addons_name'=>'','pid'=>'42','level'=>'3','is_addon'=>'0','sort'=>'3','tree'=>'tr_0 tr_1 tr_42  ','status'=>'1','created_at'=>'1582376930','updated_at'=>'1582376930']);
        /* 设置外键约束 */
