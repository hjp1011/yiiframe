...
class m210817_163345_common_menu extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%common_menu}}',['id'=>'7','title'=>'配置管理','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'6','url'=>'/common/config/index','icon'=>'','level'=>'2','dev'=>'1','sort'=>'2','params'=>'"[]"','tree'=>'tr_0 tr_6 ','status'=>'1','created_at'=>'1572330103','updated_at'=>'1572560457']);
        $this->insert('{{%common_menu}}',['id'=>'8','title'=>'菜单管理','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'6','url'=>'/common/menu/index','icon'=>'fa-puzzle-piec','level'=>'2','dev'=>'1','sort'=>'1','params'=>'"[]"','tree'=>'tr_0 tr_6 ','status'=>'1','created_at'=>'1572408688','updated_at'=>'1615908262']);
        $this->insert('{{%common_menu}}',['id'=>'9','title'=>'部门管理','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'0','url'=>'/base/department/index','icon'=>'fa-user-plus','level'=>'1','dev'=>'0','sort'=>'2','params'=>'"[]"','tree'=>'tr_0 ','status'=>'1','created_at'=>'1617449954','updated_at'=>'1617450104']);
        $this->insert('{{%common_menu}}',['id'=>'10','title'=>'插件市场','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'0','url'=>'/plugs','icon'=>'fa-cubes','level'=>'2','dev'=>'1','sort'=>'5','params'=>'"[]"','tree'=>'tr_0 ','status'=>'1','created_at'=>'1572330081','updated_at'=>'1617449970']);
        $this->insert('{{%common_menu}}',['id'=>'11','title'=>'代码生成','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'0','url'=>'/gii','icon'=>'fa-code','level'=>'1','dev'=>'1','sort'=>'6','params'=>'"[]"','tree'=>'tr_0 ','status'=>'1','created_at'=>'1617449954','updated_at'=>'1617450104']);
        $this->insert('{{%common_menu}}',['id'=>'12','title'=>'系统信息','app_id'=>'backend','addons_name'=>'','is_addon'=>'0','cate_id'=>'1','pid'=>'0','url'=>'/common/system/info','icon'=>'fa-microchip','level'=>'1','dev'=>'1','sort'=>'7','params'=>'"[]"','tree'=>'tr_0 ','status'=>'1','created_at'=>'1572329902','updated_at'=>'1616340118']);
