...
class m210817_163345_rbac_auth_item_child extends Migration
{
    public function up()
    {
        ...
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'33','name'=>'/plugs/*','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'34','name'=>'/gii/*','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'35','name'=>'/common/system/info','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'36','name'=>'cate:2','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'42','name'=>'sysReport','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'43','name'=>'/main/login-count','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'44','name'=>'/main/member-count','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        $this->insert('{{%rbac_auth_item_child}}',['role_id'=>'1','item_id'=>'45','name'=>'/main/log-count','app_id'=>'backend','is_addon'=>'0','addons_name'=>'']);
        /* 设置外键约束 */
