        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <?php foreach ($cates as $cate){ ?>
                    <li class="<?php if ($cate['id'] == $cate_id ){ echo 'active' ;}?>"><a href="<?= Url::to(['index', 'cate_id' => $cate['id']]) ?>"> <?= Yii::t('app', $cate['title']) ?></a></li>
                <?php } ?>
                <li><a href="<?= Url::to(['menu-cate/index']) ?>"> <?=Yii::t('app', '菜单分类')?></a></li>
                <li class="pull-right">
                    <?= Html::create(['ajax-edit', 'cate_id' => $cate_id], Yii::t('app', '创建'), [
                        'data-toggle' => 'modal',
