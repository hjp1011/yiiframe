            ...
            'rules' => [
                [
                    ...
                    'extraPatterns' => [
                        ...
                        'POST mobile-login' => 'mobile-login', // 验证码登陆
                        'POST register' => 'register', // 注册
                        'POST up-pwd' => 'up-pwd', // 重置密码
                        // 测试查询可删除 例如：/api/v1/default/search
                        'GET search' => 'search',
                        ...
                        'OPTIONS info'  => 'info',
                        'OPTIONS verify-access-token'  => 'verify-access-token',
                        'OPTIONS login'  => 'login',
                        'OPTIONS logout'  => 'logout',
                        'OPTIONS refresh'  => 'refresh',
                        'OPTIONS sms-code'  => 'sms-code',
                        'OPTIONS mobile-login' => 'mobile-login', // 验证码登陆
                        'OPTIONS register' => 'register', // 注册
                        'OPTIONS up-pwd' => 'up-pwd', // 重置密码
                        'OPTIONS search' => 'search',
                        'OPTIONS qr-code' => 'qr-code', // 获取小程序码
                ...
                [
                    ...
                    'extraPatterns' => [
                        ...
                        'OPTIONS images' => 'images', // 图片上传
                        'OPTIONS videos' => 'videos', // 视频上传
                        'OPTIONS voices' => 'voices', // 语音上传
                        'OPTIONS files' => 'files', // 文件上传
                        'OPTIONS base64' => 'base64', // base64上传
                        'OPTIONS merge' => 'merge', // 合并分片
                        'OPTIONS verify-md5' => 'verify-md5', // md5文件校验
                        'OPTIONS oss-accredit' => 'oss-accredit', // oss js 直传配置
                    ],
                ],
                [
